...
public class modeloCliente {
    ...
    public modeloCliente(int id_cliente, int idpuntos_cliente, int idgenero_cliente, String nombre_cliente, String apellido_cliente, String correo_cliente, String direccion_cliente, String tel_cliente, String dpi_cliente, String nit_cliente) {
