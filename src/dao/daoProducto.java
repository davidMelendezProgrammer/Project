...
public class daoProducto extends conexion{
    ...
    + "estado_producto,categoria_producto,preciocompra_producto) VALUES (?,?,?,?,?,?,?)";
    ...
    public String guardarProducto(ModeloProducto producto){
        ...
        try{
            ...
            ps.setInt(5, 1);
            ps.setInt(6, 1);
            ps.setDouble(7, producto.getPreciocompra_producto());
    ...
    public boolean eliminar(ModeloProducto product){
        int respuesta;
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Error Eiminar: " + ex);
        }
   ...
   //linda: editar en bd
    ...
    //conexion
     ...
     //Mostrar 
     public ArrayList <ModeloProducto> listaProducto(){
         
         ArrayList <ModeloProducto> lista = null;
         ...
         try{
             ...
             while(rs.next()){
                 ...
                 modpro.setId_producto(rs.getInt("id_producto"));
                 modpro.setNombre_producto(rs.getString("nombre_producto"));
                 modpro.setNumeroserie_producto(rs.getString("numeroserie_producto"));
                 modpro.setPrecio_producto(rs.getDouble("precio_producto"));
                 modpro.setCantidad_producto(rs.getInt("cantidad_producto"));
                 modpro.setEstado_producto(rs.getInt("estado_producto"));
                 modpro.setCategoria_producto(rs.getInt("categoria_producto"));
                 modpro.setCategoria_producto(rs.getInt("preciocompra_producto"));
             ...
             JOptionPane.showMessageDialog(null, "Error Lista Producto: " + ex);
         }
         
         return lista;
     }
     
     public ArrayList <modeloCategoria> listaCategoria(){
         
         ArrayList <modeloCategoria> lista = null;
         ...
         try{
             ...
             while(rs.next()){
                 ...
                 modcat.setDescripcion_categoria(rs.getString("descripcion_categoria"));
             ...
             JOptionPane.showMessageDialog(null, "Error Lista Categoria: " + ex);
         }
